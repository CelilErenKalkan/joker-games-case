...
namespace Utils
{
    public class CanvasListManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            _parentRectTransform = GetComponent<RectTransform>(); // Assuming this script is attached to the parent
        ...
        private void MoveToSelectedChild(Transform selectedChild)
        {
            ...
            _parentRectTransform.position += new Vector3(difference.x, difference.y, 0);
        }
